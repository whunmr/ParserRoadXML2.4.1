...
STK_API double intlin(double y1, double y2, double x1, double x2, double x);
...
STK_API Vector2 intlin(const Vector2& P1, const Vector2& P2, double x1, double x2, double x);
STK_API Vector3 intlin(const Vector3& P1, const Vector3& P2, double x1, double x2, double x);
